...
public class App
{
    ...
    public async Task Start()
    {
        ...
        var firstName2 = "first";
        var lastName2 = "last";

        var userId2 = await _userService.AddUser(firstName2, lastName2);
        ...
        var deleteUser2 = await _userService.DeleteUser(userId2);
        var updateProduct = await _productService.UpdateProduct(id: product1, name: "product3");
        var updateUser = await _userService.UpdateUser(userId, "Bruh");
    }
}